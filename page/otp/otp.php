            ...
            <div class="row justify-content-center">
                <div class="col-11">
                    ...
                    <form id="otpForm" action="./ajax/ajax_otp.php" method="post">
                        <h1 class="text-center h2 fw-bold mb-3 mt-1 fw-normal">รหัสยืนยัน</h1>
                        <?php
                        ...
                        <div class="form-floating mb-3">
                            ...
                            <label for="floatingPassword">รหัสยืนยัน</label>
                        </div>
                        <button name="check_otp" class="btn btn-primary w-100 py-2" type="submit">ยืนยัน</button>
                    </form>
                    <!-- End Form -->
                </div>
            </div>
